...
@RestController
//@RequestMapping("/")
public class restcontrollerMovimientos {
    @Autowired
    ...
    public MovimientoDinero guardarMovimiento(@RequestBody MovimientoDinero movimiento) {
        return movimientosServices.saveOrUpdateMovimientoRest(movimiento);
    }
    ...
    public MovimientoDinero actualizarMovimiento(@PathVariable("id") Long id, @RequestBody MovimientoDinero movimiento) {
        ...
        return movimientosServices.saveOrUpdateMovimientoRest(mov);
    }
    ...
    //controladores Rest para movimientos de una empresa especifica
