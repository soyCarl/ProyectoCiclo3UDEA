...
public class Empleado {
    ...
    public Empleado(String correoEmpleado, Perfil perfil, String rolEmpleado, Empresa empresa, List<MovimientoDinero> movDinero, Date fechaCreacion, Date fechaModificacion) {
